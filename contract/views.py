...
from	kis.lib.contract	import	GetDList,GetDData,NewD,EditD,CheckDAccess,GetAuthorEmail,SaveAuthorEmail,AddGroupEmail,GetGroupEmail,DelGroupEmail
...
def	EditPage1(request):
	...
	if form.is_valid():
	    ...
	    EditD(contract_id,contragent,tema,text)
